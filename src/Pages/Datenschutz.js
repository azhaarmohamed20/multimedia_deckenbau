    ...
    return(
        <div  className="w-[80%] m-auto mt-10 mb-10">
          <p>
            <b></b>
            <br/>Azhaar Mohamed
            <br/>Köschenrütistrasse 139
            <br/>8052 Zürich
            <br/>Schweiz
            <br/><strong>E-Mail</strong>: azhaar.mohamed@lernende.bbw.ch
            <br/>
            <strong>Datenschutzbeauftragte Person:</strong><br/>
            <br/>Azhaar Mohamed
            <br/>0786319506
            <br/>azhaar.mohamed@lernende.bbw.ch
            <br/>
            <br/><strong>Allgemein</strong>
            ...
            <br/>
            <br/><strong>Haftungsausschluss</strong><br/>Der Autor übernimmt keine Gewähr für die Richtigkeit, Genauigkeit, Aktualität, Zuverlässigkeit und Vollständigkeit der Informationen.
            <br/>Haftungsansprüche gegen den Autor wegen Schäden materieller oder immaterieller Art, die aus dem Zugriff oder der Nutzung bzw. Nichtnutzung der veröffentlichten Informationen, durch Missbrauch der Verbindung oder durch technische Störungen entstanden sind, werden ausgeschlossen.<br/>
            ...
            <br/><strong>Quelle</strong>: <a href='https://brainbox.swiss/'>BrainBox Solutions</a>
          </p>
        </div>
    )
}